...
from ..utils import LossReduction, Reduction
...
class PerceptualLoss(nn.Module):
    ...
    """
    def __init__(self, reduction: LossReduction='mean', *args, **kwargs) -> None:
        super().__init__()
        self.p = LPIPS(*args, **kwargs).eval()
